...
namespace irr
{
	...
	enum EEVENT_TYPE
	{
		...
		*/
		...
		EET_ANDROID_TOUCH_EVENT,

		EET_ANDROID_ACCELEROMETER_EVENT,
	...
	enum E_ANDROID_TOUCH_ACTION
	{
		E_ANDROID_TOUCH_DOWN,
		E_ANDROID_TOUCH_UP
	};
...
struct SEvent
{
	...
	struct SAndroidTouchEvent
	{
		int x;

		int y;

		E_ANDROID_TOUCH_ACTION action;
	};

	struct SAndroidAccelerometerEvent
	{
		float x;
		float y;
		float z;
	...
	union
	{
		...
		struct SAndroidTouchEvent AndroidTouchEvent;
		struct SAndroidAccelerometerEvent AndroidAccelerometerEvent;
	};
